...
### Prerequisites
To complete the steps outlined in this chapter, you will need to have completed the steps in the [previous chapter](/articles/tutorials/1/1.html)
...
When you're ready for the next step, head on over to [the next chapter](/articles/tutorials/1/3.html) where we'll set up our `Snake` class and get a controllable snake working.
