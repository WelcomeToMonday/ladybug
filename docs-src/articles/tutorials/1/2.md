...
When you're ready for the next step, head on over to [the next chapter](/articles/tutorials/1/3.md) where we'll set up our `Snake` class and get a controllable snake working.